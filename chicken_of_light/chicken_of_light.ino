...
void loop()
{
        ...
        case dawn_state: // если мы в режиме рассвета
        {
                ...
                LED_sunset.write(false);
                LED_night.write(false);
                if (button_night == false && button_night.isChange())
                {                                             // если была нажата кнопка ночь
                        light_algorithm_state = sunset_state; // переводим состояние алгоритма в режим закат
                }
                else if (button_sunset == false && button_sunset.isChange())
                {                                             // если же была нажата кнопка закат
                        light_algorithm_state = sunset_state; // переводим состояние алгоритма в режим закат
                }
                else if (button_day == false && button_day.isChange())
                {                                          // если же была нажата кнопка день
                        light_algorithm_state = day_state; // переводим в состояние день
                }
                else if (lighter.isMax())
                {                                          // если мы зажгли нашу лампу на полную
        ...
        case day_state:
        {
                ...
                else if (button_dawn == false && button_dawn.isChange())
                {
